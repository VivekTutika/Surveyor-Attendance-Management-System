...
SurveyorController.getSurveyorById = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    const surveyor = await surveyorService_1.SurveyorService.getSurveyorById(id);
...
SurveyorController.updateSurveyor = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const updatedSurveyor = await surveyorService_1.SurveyorService.updateSurveyor(id, updateData);
...
SurveyorController.deleteSurveyor = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    const result = await surveyorService_1.SurveyorService.deleteSurveyor(id);
...
SurveyorController.resetSurveyorPassword = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await surveyorService_1.SurveyorService.resetSurveyorPassword(id, newPassword);
    (0, response_1.sendSuccess)(res, result.message);
});
...
SurveyorController.getSurveyorStatistics = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const statistics = await surveyorService_1.SurveyorService.getSurveyorStatistics(id, startDate, endDate);
...
SurveyorController.getProjects = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const projects = await surveyorService_1.SurveyorService.getSurveyors({});
    const uniqueProjects = [...new Set(projects.map(s => s.project).filter(Boolean))];
    (0, response_1.sendSuccess)(res, 'Projects retrieved successfully', uniqueProjects);
});
...
SurveyorController.getLocations = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const surveyors = await surveyorService_1.SurveyorService.getSurveyors({});
    const uniqueLocations = [...new Set(surveyors.map(s => s.location).filter(Boolean))];
    (0, response_1.sendSuccess)(res, 'Locations retrieved successfully', uniqueLocations);
});
